...
public class MyHashtableUserKeys {
	...
	public static void main(String[] args) {
		...
		/*
		 * Below example shows how to use user defined objects as keys. To avoid
		 * duplicates keys you have to implement equals and hashcode methods. In below
		 * example we are using Emp object as key, and it has implemented equals, and
		 * hashcode methods. Example also enters duplicate object as key, and you can
		 * see that Hashtable eleminates the duplicate keys
		 */
