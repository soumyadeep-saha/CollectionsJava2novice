...
public class MyHashtableDupEntry {
	...
	public static void main(String[] args) {
		...
		/*
		 * Below example shows how to use user defined objects as keys and delete
		 * entries. To do this, you have to implement equals and hashcode methods. In
		 * below example we are using Emp object as key, and it has implemented equals,
