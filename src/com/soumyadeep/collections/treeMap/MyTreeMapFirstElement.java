...
public class MyTreeMapFirstElement {
	...
	public static void main(String[] args) {
		...
		/*
		 * Below example shows how to get first key from TreeMap based on sorting. To
		 * get first element, you have to sort the TreeMap based on user defined objects
		 ...
		 * keys are in sorting order, you can call firstKey() method to get the first
		 * key, then you can get the corresponding value object.
		 */
