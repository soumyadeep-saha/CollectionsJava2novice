...
public class MyTreeMapComparator {
	...
	public static void main(String[] args) {
		...
		/*
		 * Below example shows how to use Comparator with TreeMap. Comarator is required
		 * to implement your own sorting logic. You have to provide the sorting logic
		 * inside compare methods. Comparator is very much useful if you are working
